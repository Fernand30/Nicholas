# source: https://hub.docker.com/r/dockerniko/gitlab-ci-react-native-android/~/dockerfile/
# Pull base image.
FROM ubuntu:14.04
...
ENV ANDROID_BUILD_TOOLS_VERSION build-tools-26.0.1,build-tools-25.0.2,build-tools-23.0.2,build-tools-23.0.3,build-tools-23.0.1
